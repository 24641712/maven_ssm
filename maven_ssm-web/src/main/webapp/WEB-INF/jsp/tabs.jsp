...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/js/modernizr.custom.04022.js"></script>
    <!--clock init-->
</head>
<body>
            ...
            <div class="outter-wp">
                ...
                <div class="tab-main">
                    ...
                    <div class="tab-inner">
                        ...
                        <script src="${pageContext.request.contextPath}/static/js/cbpFWTabs.js"></script>
                        <script>
