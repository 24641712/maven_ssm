...
<div class="page-container">
                            ...
                            <div class="inbox-right">
                                ...
                                <div class="mailbox-content">
                                    ...
                                    <table class="table">
                                        ...
                                        <tr class="table-row">
                                            <td class="table-img">
                                                <img src="${pageContext.request.contextPath}/static/images/in.jpg" alt="" />
                                            </td>
                                            <td class="table-text">
                                                <h6> Lorem ipsum</h6>
                                        ...
                                        <tr class="table-row">
                                            <td class="table-img">
                                                <img src="${pageContext.request.contextPath}/static/images/in1.jpg" alt="" />
                                            </td>
                                            <td class="table-text">
                                                <h6> Lorem ipsum</h6>
                                                <p>Nullam quis risus eget urna mollis ornare vel eu leo</p>
                                        ...
                                        <tr class="table-row">
                                            <td class="table-img">
                                                <img src="${pageContext.request.contextPath}/static/images/in2.jpg" alt="" />
                                            </td>
                                            <td class="table-text">
                                                <h6> Lorem ipsum</h6>
                                                <p>Nullam quis risus eget urna mollis ornare vel eu leo</p>
                                        ...
                                        <tr class="table-row">
                                            <td class="table-img">
                                                <img src="${pageContext.request.contextPath}/static/images/in3.jpg" alt="" />
                                            </td>
                                            <td class="table-text">
                                                <h6> Lorem ipsum</h6>
                                                <p>Nullam quis risus eget urna mollis ornare vel eu leo</p>
                                        ...
                                        <tr class="table-row">
                                            <td class="table-img">
                                                <img src="${pageContext.request.contextPath}/static/images/in4.jpg" alt="" />
                                            </td>
                                            <td class="table-text">
                                                <h6> Lorem ipsum</h6>
                                                <p>Nullam quis risus eget urna mollis ornare vel eu leo</p>
                                        ...
                                        <tr class="table-row">
                                            <td class="table-img">
                                                <img src="${pageContext.request.contextPath}/static/images/in5.jpg" alt="" />
                                            </td>
                                            <td class="table-text">
                                                <h6> Lorem ipsum</h6>
                                                <p>Nullam quis risus eget urna mollis ornare vel eu leo</p>
                                        ...
                                        <tr class="table-row">
                                            <td class="table-img">
                                                <img src="${pageContext.request.contextPath}/static/images/in6.jpg" alt="" />
                                            </td>
                                            <td class="table-text">
                                                <h6> Lorem ipsum</h6>
                                                <p>Nullam quis risus eget urna mollis ornare vel eu leo</p>
                                        ...
                                        <tr class="table-row">
                                            <td class="table-img">
                                                <img src="${pageContext.request.contextPath}/static/images/in7.jpg" alt="" />
                                            </td>
                                            <td class="table-text">
                                                <h6> Lorem ipsum</h6>
                                                <p>Nullam quis risus eget urna mollis ornare vel eu leo</p>
                                        ...
                                        <tr class="table-row">
                                            <td class="table-img">
                                                <img src="${pageContext.request.contextPath}/static/images/in8.jpg" alt="" />
                                            </td>
                                            <td class="table-text">
                                                <h6> Lorem ipsum</h6>
                                                <p>Nullam quis risus eget urna mollis ornare vel eu leo</p>
                                        ...
                                        <tr class="table-row">
                                            <td class="table-img">
                                                <img src="${pageContext.request.contextPath}/static/images/in9.jpg" alt="" />
                                            </td>
                                            <td class="table-text">
                                                <h6> Lorem ipsum</h6>
                                                <p>Nullam quis risus eget urna mollis ornare vel eu leo</p>
                                        ...
                                        <tr class="table-row">
                                            <td class="table-img">
                                                <img src="${pageContext.request.contextPath}/static/images/in10.jpg" alt="" />
                                            </td>
                                            <td class="table-text">
                                                <h6> Lorem ipsum</h6>
                                                <p>Nullam quis risus eget urna mollis ornare vel eu leo</p>
                                        ...
                                        <tr class="table-row">
                                            <td class="table-img">
                                                <img src="${pageContext.request.contextPath}/static/images/in11.jpg" alt="" />
                                            </td>
                                            <td class="table-text">
                                                <h6> Lorem ipsum</h6>
                                                <p>Nullam quis risus eget urna mollis ornare vel eu leo</p>
    ...
    <div class="sidebar-menu">
        ...
        <div class="down">
            ...
            <ul>
                <li><a class="tooltips" href="${pageContext.request.contextPath}/index/index.do"><span>Profile</span><i class="lnr lnr-user"></i></a></li>
                <li><a class="tooltips" href="${pageContext.request.contextPath}/index/index.do"><span>Settings</span><i class="lnr lnr-cog"></i></a></li>
                <li><a class="tooltips" href="${pageContext.request.contextPath}/index/index.do"><span>Log out</span><i class="lnr lnr-power-switch"></i></a></li>
            </ul>
        </div>
        <!--//down-->
        <div class="menu">
