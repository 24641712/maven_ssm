                    ...
                    <div class="chat-mdl-grid widget-shadow ">
                        ...
                        <div class="scrollbar" id="style-2">
                            <div class="activity-row activity-row1 activity-right">
                                <div class="col-xs-3 activity-img"><img src="${pageContext.request.contextPath}/static/images/in.jpg" class="img-responsive" alt=""></div>
                            ...
                            <div class="activity-row activity-row1 activity-left">
                                ...
                                <div class="col-xs-3 activity-img"><img src="${pageContext.request.contextPath}/static/images/in1.jpg" class="img-responsive" alt=""></div>
                                <div class="clearfix"> </div>
                            </div>
                            <div class="activity-row activity-row1 activity-right">
                                <div class="col-xs-3 activity-img"><img src="${pageContext.request.contextPath}/static/images/in2.jpg" class="img-responsive" alt=""></div>
                                <div class="col-xs-9 activity-img1">
                                    <div class="activity-desc-sub">
                            ...
                            <div class="activity-row activity-row1 activity-left">
                                ...
                                <div class="col-xs-3 activity-img"><img src="${pageContext.request.contextPath}/static/images/in8.jpg" class="img-responsive" alt=""></div>
                                <div class="clearfix"> </div>
                            </div>
                            <div class="activity-row activity-row1 activity-left">
                                <div class="col-xs-9 activity-img2">
                                ...
                                <div class="col-xs-3 activity-img"><img src="${pageContext.request.contextPath}/static/images/in4.jpg" class="img-responsive" alt=""></div>
                                <div class="clearfix"> </div>
                            </div>
                            <div class="activity-row activity-row1 activity-right">
                                <div class="col-xs-3 activity-img"><img src="${pageContext.request.contextPath}/static/images/in5.jpg" class="img-responsive" alt=""></div>
                                <div class="col-xs-9 activity-img1">
                                    <div class="activity-desc-sub">
                                        <p>Consectetur adipisicing elit. Atque ea mollitia pariatur porro quae se</p>
                                        <span>6:52 PM</span>
