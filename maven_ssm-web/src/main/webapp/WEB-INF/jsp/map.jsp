...
<head>
    ...
    <!-- map -->
    <link href="${pageContext.request.contextPath}/static/css/jqvmap.css" rel='stylesheet' type='text/css' />
    <script src="${pageContext.request.contextPath}/static/js/jquery.vmap.js"></script>
    <script src="${pageContext.request.contextPath}/static/js/jquery.vmap.sampledata.js" type="text/javascript"></script>
    <script src="${pageContext.request.contextPath}/static/js/jquery.vmap.world.js" type="text/javascript"></script>
...
<!--js -->
<script src="${pageContext.request.contextPath}/static/js/datamaps-all.js"></script>
