...
<head>
    ...
    <!--Calender-->
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/css/clndr.css" type="text/css" />
    <script src="${pageContext.request.contextPath}/static/js/underscore-min.js" type="text/javascript"></script>
    <script src= "${pageContext.request.contextPath}/static/js/moment-2.2.1.js" type="text/javascript"></script>
    <script src="${pageContext.request.contextPath}/static/js/clndr.js" type="text/javascript"></script>
    <script src="${pageContext.request.contextPath}/static/js/site.js" type="text/javascript"></script>
    <!--End Calender-->
    <!--clock init-->
</head>
<body>
