...
<head>
    ...
    <script src="${pageContext.request.contextPath}/static/js/data/jspLogin.js"></script>
    <!--clock init-->
</head>
<body>
<!--/login-->
        ...
        <div class="login">
            ...
            <form>
                ...
                <div class="new">
                    ...
                    <p class="sign">还没有账户，<a href="${pageContext.request.contextPath}/user/Hello.do">点击注册</a></p>
                    <div class="clearfix"></div>
                </div>
            </form>
        </div>
