...
<head>
    ...
    <link href="${pageContext.request.contextPath}/static/css/atlas.css" rel='stylesheet' type='text/css' />
    <script src="${pageContext.request.contextPath}/static/js/atlas.js"></script>
    <script src="${pageContext.request.contextPath}/static/js/arbor.js"></script>
